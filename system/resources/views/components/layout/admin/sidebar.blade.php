<div class="main-menu">
    ...
    <div data-simplebar>
        <ul class="app-menu">
            ...
            <li class="menu-item">
                <a href="#menupenelitian" data-bs-toggle="collapse" class="menu-link waves-effect waves-light">
                    <span class="menu-icon"><i class="bx bx-list-ul"></i></span>
                    <span class="menu-text"> Penelitian </span>
                    <span class="menu-arrow"></span>
                </a>
                <div class="collapse" id="menupenelitian">
                    <ul class="sub-menu">
                        <li class="menu-item">
                            <a href="#" class="menu-link">
                                <span class="menu-text">Penelitian Internal</span>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="#" class="menu-link">
                                <span class="menu-text">Penelitian Eksternal</span>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="pages-login.html" class="menu-link">
                                <span class="menu-text">Penelitian Mahasiswa</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="menu-item">
                <a href="#menuPengabdian" data-bs-toggle="collapse" class="menu-link waves-effect waves-light">
                    <span class="menu-icon"><i class="bx bx-list-ul"></i></span>
                    <span class="menu-text"> Pengabdian </span>
                    <span class="menu-arrow"></span>
                </a>
                <div class="collapse" id="menuPengabdian">
                    <ul class="sub-menu">
                        <li class="menu-item">
                            <a href="#" class="menu-link">
                                <span class="menu-text">PKM Internal</span>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="#" class="menu-link">
                                <span class="menu-text">PKM Eksternal</span>
                            </a>
                        </li>
            ...
            <li class="menu-item">
                ...
                <div class="collapse" id="menuLayanan">
                    <ul class="sub-menu">
                        <li class="menu-item">
                            <a href="#" class="menu-link">
                                <span class="menu-text">Pendaftaran Hak Cipta</span>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="#" class="menu-link">
                                <span class="menu-text">Buku Panduan</span>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="pages-login.html" class="menu-link">
                                <span class="menu-text">Perdir HKI</span>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="pages-login.html" class="menu-link">
                                <span class="menu-text">Pendaftaran Desain & Merk</span>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="pages-login.html" class="menu-link">
                                <span class="menu-text">Pendaftaran Paten</span>
                            </a>
                        </li>
